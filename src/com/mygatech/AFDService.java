...
public class AFDService extends Service {
	...
	public int onStartCommand(Intent intent, int flag, int startId){
		...
		camera.startPreview();
		if(getSharedPreferences(MainActivity.USER_DETAILS,0).getString("username", null).equals("hlee652")||
				getSharedPreferences(MainActivity.USER_DETAILS,0).getString("username", null).equals("rrego6"))
